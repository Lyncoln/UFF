...
$\beta_1$: Variação de percentual de pacientes infectados para cada  unidade de aumento no tempo médio de internação;  
...
**Modelo ajustado: Veja a \hyperref[tab:summary]{\underline{tabela \ref*{tab:summary}}} no apêndice.**
